...
if("TRUE" STREQUAL "TRUE")
  set(loam_velodyne_SOURCE_PREFIX /home/arcs_20/LOAM_NOTED/src/loam_velodyne)
  set(loam_velodyne_DEVEL_PREFIX /home/arcs_20/LOAM_NOTED/devel)
  ...
  set(loam_velodyne_INSTALL_PREFIX /home/arcs_20/LOAM_NOTED/install)
...
if(NOT "/home/arcs_20/LOAM_NOTED/src/loam_velodyne/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4 " STREQUAL " ")
  set(loam_velodyne_INCLUDE_DIRS "")
  set(_include_dirs "/home/arcs_20/LOAM_NOTED/src/loam_velodyne/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'cuitaixiang <754060645@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'loam_velodyne' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arcs_20/LOAM_NOTED/src/loam_velodyne/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/arcs_20/LOAM_NOTED/devel/lib;/opt/ros/noetic/lib)
